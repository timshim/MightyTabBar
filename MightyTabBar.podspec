#
#  Be sure to run `pod spec lint MightyTabBar.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Tim Shim"
  # s.authors            = { "Tim Shim" => "timshim@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Tim Shim"
